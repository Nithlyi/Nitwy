...
COGS_ENABLED = {
    "fun": [
        ...
        "commands.fun.eightball",      # exemplo futuro
        # "commands.fun.outro_divertido",
    ],
    ...
    "utils": [
        ...
        "commands.utils.casamento",
        "commands.utils.botinfo",
        "commands.utils.serverinfo",
    ],
    
    # Adicione novas categorias aqui quando precisar
    # "games": [...],
    # "music": [...],
}
